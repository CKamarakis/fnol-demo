...
const SHOTS = [
  ...
  ['driver-archive-de', { persona: 'driver', screen: 'archive', scenario: 'collision', navStack: ['done'], lang: 'de', notes: false, reference: 'INS-DE-2026-1', draft: { injured:true, injuredParties:['driver','pedestrian'], injurySeverity:['walking'], injuryEmergency:true, cargoLaden:true, cargoDesc:'24 Paletten', trailer:'B-RL 8829', hazardous:true, witnessPresent:true, witnessName:'Anna', policeAttended:true, policeRef:'2026/074', otherPlate:'M-XY 1234', otherInsurer:'Eine Versicherung', easA:[1,5], easB:[12], sigA:'x', sigB:'x', sketch:'x' } }],
