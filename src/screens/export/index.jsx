...
export function buildIncidentJson(){
  ...
  return {
    ...
    // Both halves come from the draft. This used to splice the stored time onto
    // TODAY's date, so an incident reported yesterday exported as today's — and
    // the date of loss is ACORD 2 · 21, which decides limitation periods.
  ...
  doc.append(el("div",{class:"eas-doc-head"},
    el("div",{},
      ...
      el("p",{class:"sub",style:"margin-top:5px",
        text:"Reference "+(s.reference||"—")+"  ·  "+d.occurredAt+(d.occurredOn?" "+d.occurredOn:"")+"  ·  "+d.location})),
