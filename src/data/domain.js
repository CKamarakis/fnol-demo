...
export const STR = {
  en:{
    ...
    tier1:"Check what we already know", tier1sub:"Tap each line if it looks right. Fix anything that doesn't — nothing else can block you.",
  ...
  de:{
    ...
    tier1:"Prüfen Sie, was wir schon wissen", tier1sub:"Tippen Sie jede Zeile an, wenn sie stimmt. Korrigieren Sie, was nicht passt.",
  ...
  pl:{
    ...
    tier1:"Sprawdź, co już wiemy", tier1sub:"Dotknij każdej linii, jeśli się zgadza. Popraw to, co się nie zgadza.",
